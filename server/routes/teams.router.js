...
router.get('/:id', (req, res) => {
  const sqlText=`select teams.team_name, teams.about_us, players.id, players.team_id, teams.id
  from teams join players on teams.id = players.team_id where players.id = $1;`;
